...
<html>
   ...
   <link href="vendor/datepicker/daterangepicker.css" rel="stylesheet" media="all">
    ...
    <header id="header" class="alt">
      <div class="logo"><a href="home2.php">Welcome to <span> Student Registration Portal</span></a></div>
      <a href="#menu">Menu</a>
    </header>
		...
		<!-- One -->
			<div class="wrapper-style4" >
					<header class="align-center">
					  <h2 style="color:white; margin-top: 40px; font-size: 60px; font-family: FontAwesome">Student Login </h2>
					</header>
			</div>

    <div class="signup-form" style="padding: 10px 50px 50px 300px ">
    <div class="main-div">
      <div class="panel panel-default" style="padding: 20px 15px" >
       <h2 style="margin-top: 10px; margin-bottom: 20px; text-align: center; color:white; font-family: FontAwesome">Signin</h2> 
       <form id="signup" method="post">
           ...
           <div class="form-group">
               <input type="email" class="form-control" id="inputEmail" placeholder="Email Address" name="e" required>
               <h3 style="color:black;font-size: 16px" ></h3>
            </div>


            <div class="form-group">
                <input type="password" class="form-control" id="inputPassword" style="color:#006666;font-size: 16px" placeholder="Password" name="p" required>
            </div>
