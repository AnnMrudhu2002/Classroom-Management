...
$err="<h3 align='center' style='color: black'>Registration successfull !!<h3>";
		...
		<!-- One -->
			<div class="wrapper-style4" >
					<header class="align-center">
					  <h2 style="color:white; margin-top: 50px">Registration Form</h2>
					</header>
			</div>

    <div class="signup-form" style="padding: 50px 10px 50px 300px ">
    <div class="main-div">
      ...
      <!-- <h2 style="margin-top: 10px; margin-bottom: 20px; text-align: center; color:#ffffff">Student Signup</h2> -->
       <form id="signup" method="post" enctype="multipart/form-data">
          ...
          <div class="form-group" >
           ...
           <div class="form-group">
               <input type="email" class="form-control" id="inputEmail" style="color:white;font-size: 16px;background_color:transparent" placeholder="Email Address" name="e" required>
            </div>
            ...
            <div class="form-group">
                <select class="form-control" id="inputProgram" style="color:white;font-size: 16px;background-color: transparent" placeholder="Program" name="pro" required>
                  ...
                  <option style="color:black">B.Tech</option>
						...
						<div class="form-group">
								<select class="form-control" id="inputSemester" style="font-size: 16px;background-color: transparent; color:white" placeholder="Semster" name="sem" required>
