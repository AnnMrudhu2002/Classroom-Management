...
<html>
   ...
   <link href="vendor/datepicker/daterangepicker.css" rel="stylesheet" media="all">
    ...
    <header id="header" class="alt">
      <div class="logo"><a href="home.php">Welcome to <span>Admin Portal</span></a></div>
      <a href="#menu">Menu</a>
    </header>
    ...
    <nav id="menu">
      ...
      <ul class="links">
		...
		<!-- One -->
            ...
            <h2 style="color:white; margin-top: 40px; font-size: 60px; font-family: FontAwesome">Admin Login </h2>
					</header>
			</div>
           ...
           <div class="form-group">
            ...
            <div class="form-group">
                <input type="password" class="form-control" id="inputPassword" style="color:whit;font-size: 16px" placeholder="Password" name="pass" required>
						...
						<input type="submit" value="Login" class="btn btn-info" style=" background-color:cyan"  name="login"/>
