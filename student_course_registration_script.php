...
foreach($_POST['courses'] as $course)
{
    ...
    { //       echo $_SESSION['id'];
        $insert_query = "insert into course_registration(student_id, name, course_id, teacher_id, teacher_name, status) values ('$_SESSION[id]', '$name','$course', '$row[id]', '$row[name]', 'Pending')";
