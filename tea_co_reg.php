                    ...
                    <div class="row panel panel-default">
                        <div class="col-md-12">
                              ...
                              <div style="margin-top: 30px;margin-bottom: 20px">
                                  ...
                                  <table style="width: 100%; border-spacing: 60px; ">
                                      <tr colspan: "2">
                                          <th> Student Id     </th>
                                          <th>  Name </th>
                              ...
                              {
                                 //echo $course;
                                  $select_query = "select id, name from user where id in (select student_id from course_registration where status = 'Pending')";
