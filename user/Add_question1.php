	            ...
	            <div class="content" >
	                <div class="container-fluid">
	                    <div class="row panel panel-default">
                        	          ...
                        	          <form method="post" action="add_question_script.php" style="margin-top: 80px">
	                        ...
	                        <div class="col-md-12">
	                            <div class="card">
	                                <div class="header">
	                                    <h4 class="title">Ask Your Question</h4>
	                                </div>
	                                <div class="content">
	                                        ...
	                                        <div class="row">
	                                            ...
	                                            <div class="col-md-10">
	                                                <div class="form-group">
	                                                    <label><b> Title of the question </b></label>
                                          ...
                                          <div class="row">
                                              ...
                                              <div class="col-md-12">
                                                  <div class="form-group">
                                                      ...
                                                      <textarea class="form-control" id="mytextarea" rows="8" cols="103" name="question" required> Your Question </textarea>
                                                  </div>
                                              </div>
                                            </div>
